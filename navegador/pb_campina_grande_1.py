...
class PBCampinaGrande:
    ...
    def processar_meses_da_folha(self, orgao, ano, arquivo_exportar):
        ...
        with open(arquivo_exportar, "w") as f:
            ...
            for mes in range(1, qtde_meses + 1):
                ...
                self.popular_arquivo_de_exportacao(f, orgao, ano, mes, dados_nivel_1)
    ...
    def coletar_dados_do_nivel_2(self):
 
        linha = self.buscador.obter_valor_de_xpath('/html/body/div[2]/div[2]/table/tbody/tr[2]/td[1]')
        descricao = self.buscador.obter_valor_de_xpath('/html/body/div[2]/div[2]/table/tbody/tr[3]/td[2]')
        valor_do_mes1 = self.buscador.obter_valor_de_xpath('/html/body/div[2]/div[2]/table/tbody/tr[4]/td[3]')
        servidores_do_mes1 = self.buscador.obter_valor_de_xpath('/html/body/div[2]/div[2]/table/tbody/tr[5]/td[4]')
        pos4 = self.buscador.obter_valor_de_xpath('/html/body/div[2]/div[2]/table/tbody/tr[6]/td[4]')

        return [linha, descricao, valor_do_mes1, servidores_do_mes1, pos4]        
    ...
    def popular_arquivo_de_exportacao(self, arquivo, orgao, ano, mes, dados_nivel_1):
        ...
        for funcionario in range(1, qtde_funcionarios + 1):
            ...
            dados_nivel_2 = self.coletar_dados_do_nivel_2()
