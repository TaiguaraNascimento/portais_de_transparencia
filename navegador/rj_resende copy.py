...
class RJResende:
    ...
    def colecionar_dados_das_paginas(self, lista_de_pessoas):
        ...
        while parar == False:
            ...
            # Clicar no botão expandir todos
            self.buscador.clicar_no_elemento_xpath('/html/body/div[1]/div[1]/div/div/div/form/div[1]/div[1]/div[2]/div/div[2]/span[1]/input[1]')
    ...
    def copiar_lista_de_dados(self, lista_de_retorno, pagina):
        ...
        for linha in range(0, qtde):
            ...
            nome = self.buscador.obter_valor_de_xpath('/html/body/div[1]/div[1]/div/div/div/form/div[1]/div[1]/div[2]/div/div[3]/table[2]/tbody[' + str(numero) + ']/tr/td/ul/li[1]/label[1]')
                                                       ...
                                                       /html/body/div[1]/div[1]/div/div/div/form/div[1]/div[1]/div[2]/div/div[3]/table[2]/tbody[4]/tr/td/ul[1]/li[8]/a

            self.clicar_no_botao_de_cifrao(numero)

            self.buscador.pausa_media()

            # self.clicar_no_botao_de_fechar_popup()
    ...
    def clicar_no_botao_de_cifrao(self, numero):
        
        # Clicar no cifrão pra abrir o valor
        # self.buscador.clicar_no_elemento_por_id('mainForm:itensInfoServidores:' + str(numero) + ':linkInformacoesSalariais')

        self.buscador.clicar_no_elemento_xpath('/html/body/div[1]/div[1]/div/div/div/form/div[1]/div[1]/div[2]/div/div[3]/table[2]/tbody[' + str(numero) + ']/tr/td/ul[1]/li[8]/a')

                                                /html/body/div[1]/div[1]/div/div/div/form/div[1]/div[1]/div[2]/div/div[3]/table[2]/tbody[2]/tr/td/ul[1]/li[8]/a


    def clicar_no_botao_de_fechar_popup(self):

        # Clicar no botão fechar
        self.buscador.clicar_no_elemento_xpath('/html/body/div[1]/div[1]/div/div/div/form/div[4]/div/div/a')
